...
function renderTaskForm(task) {
    ...
    if (task) { // if task is passed as argument ( e.g. edit )
        ...
        dueDate.value = !(task.date) ? null : (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.date, {representation: 'date'})
