...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initializeAllFilters": () => (/* binding */ initializeAllFilters),
/* harmony export */   "removeFilterSelector": () => (/* binding */ removeFilterSelector),
/* harmony export */   "selectTaskFilter": () => (/* binding */ selectTaskFilter),
/* harmony export */   "viewDefault": () => (/* binding */ viewDefault)
/* harmony export */ });
/* harmony import */ var _tasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tasks */ "./src/scripts/tasks.js");
/* harmony import */ var _tasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks */ "./src/scripts/dom/tasks.js");
...
/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projects */ "./src/scripts/dom/projects.js");
...
function initializeAllFilters() {
    ...
    initializeFilter('.all', ()=> (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)(), 'all tasks')
    initializeFilter('.today', () => (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.date)), 'today')
    initializeFilter('.week', () => (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date)), 'this week')
    initializeFilter('.important', () => (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task) => task.important), 'important')
    initializeFilter('.completed', () => (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task)=> task.done), 'completed')
}
...
function selectTaskFilter(filterElement, tasks, header) {
    (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.setSelectedProject)('')
    ;(0,_tasks__WEBPACK_IMPORTED_MODULE_0__.setSelectedFilter)(header)
    ;(0,_tasks__WEBPACK_IMPORTED_MODULE_0__.setCurrentTasks)(tasks)

    removeFilterSelector()
    filterElement.className = 'selected'

    ;(0,_projects__WEBPACK_IMPORTED_MODULE_2__.renderProjects)()
    ;(0,_tasks__WEBPACK_IMPORTED_MODULE_1__.renderContainer)()
}
...
function viewDefault(){
    selectTaskFilter(allFilter, () => (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)(), 'all tasks')
}

/***/ }),

/***/ "./src/scripts/dom/projects.js":
/*!*************************************!*\
  !*** ./src/scripts/dom/projects.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "configureAddProjectButton": () => (/* binding */ configureAddProjectButton),
/* harmony export */   "configureNavButton": () => (/* binding */ configureNavButton),
/* harmony export */   "renderProjectHeader": () => (/* binding */ renderProjectHeader),
/* harmony export */   "renderProjects": () => (/* binding */ renderProjects)
/* harmony export */ });
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filters */ "./src/scripts/dom/filters.js");
/* harmony import */ var _tasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks */ "./src/scripts/dom/tasks.js");
...
function renderProjects() {
    const projectsArray = Object.keys(_tasks__WEBPACK_IMPORTED_MODULE_2__.allProjects).map(project => {

        const projectItem = document.createElement('h3')
        projectItem.textContent = project

        if (project === (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getSelectedProject)()) projectItem.className = 'selected'
...
function renderProjectHeader() {
    ...
    if ((0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getSelectedProject)() !== '') {
    projectTitle.textContent = (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getSelectedProject)()

        const addTask = document.createElement('button')
        addTask.addEventListener('click', () => {
            ;(0,_tasks__WEBPACK_IMPORTED_MODULE_1__.renderTaskForm)()
        })
        projectTitle.append(addTask)

    } else {
        projectTitle.textContent = (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getSelectedFilter)()
    }
...
function renderProjectForm() {
    ...
    projectName.addEventListener('input', () => {
        if (projectName.value in _tasks__WEBPACK_IMPORTED_MODULE_2__.allProjects) {
    ...
    projectForm.addEventListener('submit', (e) => {
        ...
        ;(0,_tasks__WEBPACK_IMPORTED_MODULE_2__.newProject)(formData.get('projectName'))
        renderProjects()
        removeForm()
        ;(0,_tasks__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)()
    })
...
function deleteProject(project, e){
    ...
    delete _tasks__WEBPACK_IMPORTED_MODULE_2__.allProjects[project]

    if(project === (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getSelectedProject)()){
        (0,_filters__WEBPACK_IMPORTED_MODULE_0__.viewDefault)()
    } else {
        renderProjects()
        ;(0,_tasks__WEBPACK_IMPORTED_MODULE_1__.renderContainer)()
    }
...
function openProject(project){
    (0,_filters__WEBPACK_IMPORTED_MODULE_0__.removeFilterSelector)()
    ;(0,_tasks__WEBPACK_IMPORTED_MODULE_2__.setSelectedProject)(project)
    ;(0,_tasks__WEBPACK_IMPORTED_MODULE_2__.setCurrentTasks)(()=> _tasks__WEBPACK_IMPORTED_MODULE_2__.allProjects[project])
...
/* harmony export */ });
/* harmony import */ var _tasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tasks */ "./src/scripts/tasks.js");
/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projects */ "./src/scripts/dom/projects.js");
...
function buildTaskElement(task) {
    ...
    taskDue.textContent = task.date ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, 'eee do LLL') : ''
    ...
    checkBox.addEventListener('click', () => {
        task.done = !task.done
        renderContainer()
        ;(0,_tasks__WEBPACK_IMPORTED_MODULE_0__.updateLocalStorage)()
    })
...
function deleteTask(task) {
    ...
    for (let project of Object.keys(_tasks__WEBPACK_IMPORTED_MODULE_0__.allProjects)) {
        let index = _tasks__WEBPACK_IMPORTED_MODULE_0__.allProjects[project].indexOf(task)

        if (index !== -1) {
            _tasks__WEBPACK_IMPORTED_MODULE_0__.allProjects[project].splice(index, 1)
            break
        }
    }
    renderContainer()
...
function renderContainer() {
    console.log((0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getCurrentTasks)())
    const contentArray = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getCurrentTasks)().map(buildTaskElement)

    contentArray.unshift((0,_projects__WEBPACK_IMPORTED_MODULE_1__.renderProjectHeader)())
...
function renderTaskForm(task) {
    ...
    if (task) { // if task is passed as argument ( e.g. edit )
        ...
        dueDate.value = task.date
            ? (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.date, {representation: 'date'})
            : null
...
function addTask(e) {
    e.preventDefault()
    const formData = new FormData(e.target)
    const task = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task(
        formData.get('taskName'),
        formData.get('description'),
        createDate(formData.get('dueDate')),
        formData.get('important') === "on"
    )
    _tasks__WEBPACK_IMPORTED_MODULE_0__.allProjects[(0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getSelectedProject)()].push(task)
}
...
/* harmony export */   "getCurrentTasks": () => (/* binding */ getCurrentTasks),
/* harmony export */   "getSelectedFilter": () => (/* binding */ getSelectedFilter),
/* harmony export */   "getSelectedProject": () => (/* binding */ getSelectedProject),
/* harmony export */   "loadStoredProjects": () => (/* binding */ loadStoredProjects),
/* harmony export */   "newProject": () => (/* binding */ newProject),
/* harmony export */   "setCurrentTasks": () => (/* binding */ setCurrentTasks),
/* harmony export */   "setSelectedFilter": () => (/* binding */ setSelectedFilter),
